...
>}
>```
>Ho notato che, a differenza della build locale con `npx quartz build --serve`, su github pages molti link erano rotti. 
>Questo perché durante la generazione dei file html, a quanto pare quartz crea delle pagine di "rimbalzo" create per quando nel file markdown ci sono proprietà `aliases`. 
