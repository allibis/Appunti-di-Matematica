...
> 1. $x$ è [[Punti di Aderenza|punto di aderenza]] per $A\iff x\in \overline{A}$
...
>    Allora $W^C$ è chiuso e contiene $A$, pertanto $W^C\supseteq \overline{A}$ per la [[Chiusura di un insieme#^prop-chiusura|3. proprietà dei chiusi]]. Dal momento che $x\not\in W^C\implies x\not\in \overline{A}$.
