...
> [!teorema]
> Le [[Teoria di Topologia Generale/Topologia|topologie]] [[Teoria di Topologia Generale/Topologia indotta da una metrica|indotte]] dalla [[Teoria di Topologia Generale/Metrica#^def-metrica-euclidea|metrica euclidea]] $d$ e dalla [[Teoria di Topologia Generale/Metrica#^def-inf-metrica|metrica di chebyshev]] $p$ sono uguali alla [[Teoria di Topologia Generale/Topologia Prodotto|topologia prodotto]] su $\mathbb{R}^n$.
