...
> Sia $\overline{d}(x,y)=\min\{ d(x,y),1 \}$ la [[Teoria di Topologia Generale/Metrica Uniforme|metrica uniforme]] su $\mathbb{R}$. Se $x=(x_{i}),y=(y_{i})\in \mathbb{R}^\omega$, definisco $D(x,y)=\sup\left\{  \frac{\overline{d}(x_{i},y_{i})}{i}  \right\}$. 
> Risulta che $D$ è una [[Teoria di Topologia Generale/Metrica|metrica]] e induce la [[Teoria di Topologia Generale/Topologia Prodotto|topologia prodotto]] $\tau_{\text{prod}}$.
...
> Per dimostrare che $D$ induce $\tau_{\text{prod}}$, applico il [[Teoria di Topologia Generale/Lemma sulle Metriche e Confronto tra Topologie]] in entrambe le direzioni.
> Provo innanzitutto che la topologia prodotto è più [[Teoria di Topologia Generale/Confronto Tra Topologie|fine]] della topologia indotta da $D$.
