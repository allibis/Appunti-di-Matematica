...
> [!proprietà] Proprietà
> Sia $(X,\tau)$ [[Teoria di Topologia Generale/Topologia|spazio topologico]] e $A,B\subseteq X$. Allora valgono le seguenti proprietà dell'[[Teoria di Topologia Generale/Interno|interno]], [[Teoria di Topologia Generale/Esterno|esterno]] e [[Teoria di Topologia Generale/Frontiera|frontiera]] di $A,B$:
