...
> Sia $f_{n}$ una successione di funzioni da $X$ [[Teoria di Topologia Generale/Topologia|spazio topologico]] a $Y$ [[Teoria di Topologia Generale/Spazio metrico|spazio metrico]]. 
> Se $f_{n}$ [[Teoria di Topologia Generale/Convergenza Uniforme|converge uniformemente]] a $f$, allora $f$ è [[Teoria di Topologia Generale/Mappa Continua|continua]] 
...
> Per la [[Teoria di Topologia Generale/Convergenza Uniforme|uniforme convergenza]] di $f_{n}$ si ha che $\displaystyle \exists N\in \mathbb{N}\, \vert \,\forall n>N: d(f_{N}(x),f(x))<\frac{\varepsilon}{3}\,\,\forall x\in X$.
