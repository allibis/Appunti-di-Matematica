...
> Sia $(X,\tau)$ uno [[Teoria di Topologia Generale/Topologia|spazio topologico]] e $x\in X$. Si dice che $V\subseteq X$ è **intorno** di $x$ se $\exists A\in \tau\mid x\in A\subseteq V$.
^def-intorno
