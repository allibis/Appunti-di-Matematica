...
> Sia $X\not=\varnothing$  e $d(x,y)$ una [[Teoria di Topologia Generale/Metrica|metrica]] su $X$. Sia $\tau_{d}$ la [[Teoria di Topologia Generale/Topologia indotta da una metrica|topologia indotta]].
> Allora $\tau_{d}$ è [[Teoria di Topologia Generale/Spazio topologico Primo-numerabile|I-numerabile]]

> [!dim]
> Considero $\mathcal{U}(x)=\{ B_{1/n}(x)\mid x\in X,n\in \mathbb{N}^+\}$.
> Dimostro che è [[Teoria di Topologia Generale/Sistema fondamentale di intorni|sistema fondamentale di intorni]]. 
