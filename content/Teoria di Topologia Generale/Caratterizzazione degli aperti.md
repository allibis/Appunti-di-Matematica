...
> [!teorema] Teorema
> Sia $(X,\tau)$ uno [[Teoria di Topologia Generale/Topologia|spazio topologico]]. Sia $A\subseteq X$, allora:
> $A$ è aperto di $\tau\iff A$ è [[Teoria di Topologia Generale/Intorni|intorno]] di ogni suo punto.
