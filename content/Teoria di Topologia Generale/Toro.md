...
> > Il toro è definito come l'insieme $\widetilde{\mathbb{T}}:={}^{I \times I}\!/_{\sim}$ e risulta [[Teoria di Topologia Generale/Omeomorfismo|omeomorfo]] a $\mathbb{T}^2=S^1\times S^1$. 
> > Infatti, definisco $F:I \times I\to \mathbb{T}^2$ tale che
> > $(s,t)\in I \times I\longmapsto(e^{ 2\pi is },e^{ 2\pi it })$
> > Si dimostra che $F$ è una [[Teoria di Topologia Generale/Mappa Quoziente|mappa quoziente]] e inoltre vale che:
> > $\forall (t,s),(t',s')\in I \times I:F(t,s)=F(t',s')\iff(t,s)\sim (t',s')$
> > Dunque per il teorema sull'[[Teoria di Topologia Generale/Unicità della Topologia Quoziente]] si ha che $\mathbb{T}^2$ è omeomorfo a ${}^{I \times I}\!/_{\sim}$
> 
> > [!def] Definizione 3
> > 
