...
> Siano $X,Y$ [[Teoria di Topologia Generale/Topologia|spazi topologici]] e $Y$ [[Teoria di Topologia Generale/Compatto|compatto]].
...
> Poiché siamo nella [[Teoria di Topologia Generale/Topologia Prodotto|topologia prodotto]], allora $\forall y\in Y$ esiste un intorno aperto $M=U_{y}\times V_{y}\subseteq \vartheta$ ($\vartheta$ è aperto in $\tau_{\text{prod}}$) centrato in $(x_{0},y)$
