...
> Risulta che $S$ non è [[Teoria di Topologia Generale/Chiuso|chiuso]] nella [[Teoria di Topologia Generale/Topologia indotta da una metrica|topologia indotta]]  da $X$. Infatti se lo fosse, conterrebbe i suoi punti di accumulazione. Infatti, considerando la successione $\left\{\left(  \frac{2}{n},0 \right)\right\}_{n\in \mathbb{N}}\subseteq S$ tende al punto $(0,0)\not\in S$. 