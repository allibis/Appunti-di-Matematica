---
tags: [Topologia, Definizione, Continuità]
aliases: []
icon: lucide-circle-check-big
---

> [!prop] Regole per la costruzione delle funzioni continue
> Siano $(X,\tau),(Y,\tau')$ due [[Teoria di Topologia Generale/Topologia|spazi topologici]]:
> 1. Se $f:X\to Y$ è [[Teoria di Topologia Generale/Mappa Continua|funzione continua]], allora $f$ è continua.
