...
> Tale mappa è ben definita perché $\gamma(1)=\gamma'(0)$ ed è continua per il [[Teoria di Topologia Generale/Lemma dell'Incollamento]] e $\gamma''(0)=x,\gamma''(2)=z$ pertanto $x\sim z$. 