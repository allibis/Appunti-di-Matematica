...
> [!dim] 
> Supponiamo che $X$ sia uno [[Teoria di Topologia Generale/Topologia|spazio topologico]] [[Teoria di Topologia Generale/Connessione per Archi|connesso per archi]].
...
> Poiché $\gamma$ è [[Teoria di Topologia Generale/Mappa Continua|continua]], vale che:
