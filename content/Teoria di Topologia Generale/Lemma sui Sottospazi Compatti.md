...
> [!prop] Proposizione
> Sia $Y\subseteq X$  [[Teoria di Topologia Generale/Topologia di Sottospazio|sottospazio]], allora:
> $Y$ è [[Teoria di Topologia Generale/Compatto|compatto]] $\iff$ $\forall$ ricoprimento di $Y$ mediante insiemi aperti di $X$ esiste un sottoricoprimento finito che ricopre $Y$.
