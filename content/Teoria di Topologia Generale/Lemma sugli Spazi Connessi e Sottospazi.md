...
>[!prop] Lemma
> Sia $X$ uno [[Teoria di Topologia Generale/Topologia|spazio topologico]], se $C,D$ formano una [[Teoria di Topologia Generale/Spazio Connesso|separazione]] e $Y\subseteq X$ è un [[Teoria di Topologia Generale/Topologia di Sottospazio|sottospazio topologico]] connesso, allora $Y\subseteq C$ oppure $Y\subseteq D$.
