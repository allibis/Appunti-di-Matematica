...
> [!Teorema]
> Le [[Componenti Connesse|componenti connesse]] di $X$ sono sottoinsiemi [[Spazio Connesso|connessi]]  di $X$, disgiunti tra loro, la cui unione è $X$ e tali che ogni sottoinsieme connesso di $X$ ne interseca esattamente una di esse.
...
> Dunque $C=\bigcup \limits_{x\in C}A_{x}$ [[Teorema sull'Unione di Spazi Connessi|unione di connessi aventi un punto in comune]]. 
