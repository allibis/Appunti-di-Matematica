...
> La base per la [[Topologia del Limite Inferiore]] $\mathbb{R}_{\ell}$ è $\beta'=\{[a,b) | a,b\in \mathbb{R}, a<b\}$
...
> Applico la [[Topologie confrontabili e basi|proposizione precedente]] per dimostrare che $\mathbb{R}\subseteq \mathbb{R}_{\ell}$: 
