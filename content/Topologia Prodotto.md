...
> Siano $(X,\tau), (Y,\sigma)$ due [[Topologia|spazi topologici]]. La **topologia prodotto** del prodotto cartesiano $X\times Y$ è generata dalla [[Base di una Topologia|base]] $\beta=\{ U \times W\mid U\in \tau, W\in \sigma \}$.
...
> [!es] Esempio
> Considero $(\mathbb{R},\mathcal{E})$ [[Topologia Euclidea|topologia euclidea]] e $(\mathbb{R},\mathcal{P}(\mathbb{R}))$ [[Topologia Discreta|topologia discreta]], generate dalle basi $\beta_{\mathcal{E}}=\{ \left(a,b\right) \vert a,b\in \mathbb{R}\}$ e $\beta_{p}=\{ \{ x \}\vert x\in \mathbb{R} \}$.
