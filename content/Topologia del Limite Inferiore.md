...
> [!obs] Gli elementi della topologia $\tau_{\ell}$ sono sia aperti che chiusi.
^obs-topologia-lim-inf


> [!prop] Base della topologia $\mathbb{R}_{\ell}$
> La base di $\mathbb{R}_{\ell}$ è $\beta=\{[a,b) | a,b\in \mathbb{R}, a<b\}$
