...
> $K$ è [[Compatto|compatto]] $\iff$ $K$ è [[Chiuso|chiuso]] e limitato

> [!dimostrazione] $\implies$
> Sappiamo che $\mathbb{R}^n$ è uno spazio di [[Hausdorff]].
> Poiché $K$ è compatto, sappiamo anche che è chiuso [(!)](<I Sottospazi Compatti di Spazi T2 sono Chiusi>)
...
> Osservo che l'insieme $[-L,L]^n$ è compatto perché [[Il prodotto finito di Compatti é Compatto|prodotto finito di compatti]].
> E poiché $K$ è un [[Teorema Sui Sottospazi Chiusi Dei Compatti|sottospazio chiuso di un compatto]], allora è compatto. 