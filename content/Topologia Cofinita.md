...
> $\displaystyle\left(\bigcup_{j\in J}U_{j}\right)=\bigcap_{j\in J}(U_{j}^C) \subseteq U_{j}^C \implies \left|\left(\bigcup_{j\in J}U_{j}\right)\right|\leq\left|U_{j}^C\right|<+\infty$
