...
> (l'idea è che avendo scelto un $x_{0}$ generico, dimostrerei che per ogni $x\in f^{-1}(V)$ quest'ultimo è intorno di ogni suo punto, e per la [[Caratterizzazione degli aperti]] $f^{-1}(V)$ è aperto)
