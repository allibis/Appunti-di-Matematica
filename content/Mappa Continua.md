...
> [!def] Mappa continua
> Siano $(X,\tau),(Y,\tau')$ [[Topologia|spazi topologici]] e sia $f:A\to B$ una mappa. 
...
> Siano $(X,\tau),(Y,\tau')$ [[Topologia|spazi topologici]] e sia $f:A\to B$ una mappa. 
> Essa si dice **continua** in $x_{0}\in X$ se $\forall V$ [[Intorni|intorno]] aperto di $f(x_{0})$ esiste $U$ intorno aperto di $x_{0}$ tale che $f(U)\subseteq V$
^def-mappa-continua-in-un-punto