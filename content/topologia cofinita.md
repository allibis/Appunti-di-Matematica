...
> Grazie alla prima [[Formula di De Morgan]] si ha che $\displaystyle\left(\bigcup_{j\in J}U_{j}\right)=\bigcap_{j\in J}(U_{j}^C) \subseteq U_{j}^C. \implies \left|(\bigcup_{j\in J}U_{j})\right|\leq|U_{j}^C| <+\infty$
